...
async function allListings(): Promise<AdminListing[]> {
  const res = await getDb().query(
    `select l.id, l.slug, l.title, coalesce(l.headline,'') as headline, l.city,
            ...
            l.lat, l.lng, l.amenities, coalesce(l.house_rules,'') as house_rules,
  ...
  return res.rows.map((r) => ({
    ...
    lat: r.lat, lng: r.lng, amenities: r.amenities ?? [],
    houseRules: r.house_rules, instantBook: r.instant_book,
