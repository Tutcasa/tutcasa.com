...
/** The TutCasa sun/palm mark, ported from the demo site. */
export function Logo() {
  return (
    <Link href="/" className="flex items-center gap-2.5" aria-label="TutCasa home">
      <svg viewBox="0 0 100 100" fill="none" className="h-10 w-10">
        <defs>
          <linearGradient id="tc-sun" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0" stopColor="#E4326B" />
            <stop offset="1" stopColor="#F5A623" />
          </linearGradient>
        </defs>
        <path d="M22 62 A34 34 0 1 1 78 62" stroke="url(#tc-sun)" strokeWidth="6" strokeLinecap="round" />
      ...
      <span className="leading-none">
        <span className="font-display block text-lg font-extrabold tracking-wide text-rosa">
          TUT CASA
        </span>
        <span className="block text-[9px] font-medium text-terra">
          A king in your own house
        </span>
      </span>
    </Link>
  );
