...
export const I18N: Record<Lang, Record<string, string>> = {
  en: {
    ...
    wa_title: `Contact us`, wa_sub: `replies in minutes`,
    ...
    pd_ci: `Check-in`, pd_co: `Check-out`, pd_guests: `Guests`, pd_booknow: `Book now`, pd_ask: `Contact us on WhatsApp`,
  ...
  fr: {
    ...
    wa_title: `Contactez-nous`, wa_sub: `répond en quelques minutes`,
    ...
    pd_ci: `Arrivée`, pd_co: `Départ`, pd_guests: `Voyageurs`, pd_booknow: `Réserver`, pd_ask: `Contactez-nous sur WhatsApp`,
  ...
  es: {
    ...
    wa_title: `Contáctanos`, wa_sub: `responde en minutos`,
    ...
    pd_ci: `Entrada`, pd_co: `Salida`, pd_guests: `Huéspedes`, pd_booknow: `Reservar`, pd_ask: `Contáctanos por WhatsApp`,
